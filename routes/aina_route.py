...
from src.aina import CancellableStream, StreamCancelledException, get_routes, stream_website
...
async def stop_website_stream(request: Request, user: dict = Depends(get_current_user)):
    ...
    try:
        if current_stream_token:
            ...
            return JSONResponse(content={"message": "No active stream"}, status_code=200)
